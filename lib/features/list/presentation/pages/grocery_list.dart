...
import 'package:shopping_list/features/list/presentation/pages/new_item_screen.dart';
...
class _GroceryListState extends State<GroceryList> {
  ...
  void _deleteItem(GroceryItem item) async {
    ...
    final url = Uri.https('flutter-shop-942c5-default-rtdb.firebaseio.com',
  ...
  Widget build(BuildContext context) {
    Widget content = const Center(child: Text('No data'));
